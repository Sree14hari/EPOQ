...
export default function Home() {
  ...
  return (
    <div className="min-h-screen font-sans bg-white dark:bg-black text-zinc-900 dark:text-zinc-900 dark:text-zinc-100 p-8">
      {/* Header */}
      <header className="mb-12 flex items-center justify-between">
        <div className="flex items-center gap-4">
          <div className="w-14 h-14 bg-zinc-100 dark:bg-zinc-900 rounded-full border border-zinc-200 dark:border-zinc-800 overflow-hidden shrink-0">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2 px-4 py-2 bg-zinc-100 dark:bg-zinc-100 dark:bg-zinc-900/50 border border-zinc-200 dark:border-zinc-800 rounded-full">
          ...
          <div className="relative">
            <button 
              ...
              className="flex items-center gap-2 px-4 py-2 bg-zinc-100 dark:bg-zinc-900 hover:bg-zinc-200 dark:hover:bg-zinc-800 border border-zinc-200 dark:border-zinc-800 rounded-full text-sm text-zinc-700 dark:text-zinc-700 dark:text-zinc-300 transition-colors"
            >
              ...
              <div className="absolute right-0 mt-2 w-48 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl shadow-xl z-50 overflow-hidden">
                {PRESETS.map((preset, i) => (
                  <button
                    ...
                    className="w-full px-4 py-3 text-left text-sm text-zinc-700 dark:text-zinc-700 dark:text-zinc-300 hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors flex justify-between items-center"
                  >
          ...
          <span className="text-xs text-zinc-600 hidden lg:inline">Ctrl+Enter to start</span>
           ...
           {isRunning ? (
             ...
             <button 
               ...
               className="flex items-center gap-2 px-6 py-2.5 bg-zinc-900 dark:bg-white text-white dark:text-black hover:bg-zinc-800 dark:hover:bg-zinc-200 rounded-full transition-all text-sm font-medium shadow-lg dark:shadow-white/10"
             >
      ...
      <main className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="space-y-6">
                ...
                <div className="flex gap-2">
                  <div className="relative flex-1 group">
                    <input 
                      ...
                      className="w-full bg-white dark:bg-black border border-zinc-200 dark:border-zinc-800 rounded-lg py-2.5 px-3 text-sm text-zinc-700 dark:text-zinc-700 dark:text-zinc-300 focus:border-zinc-400 dark:focus:border-zinc-600 focus:outline-none transition-colors font-mono"
                    />
                  </div>
                  <button 
                     onClick={handlePickDataset}
                     className="p-2.5 bg-white dark:bg-black hover:bg-zinc-100 dark:hover:bg-zinc-800 border border-zinc-200 dark:border-zinc-800 rounded-lg text-zinc-500 dark:text-zinc-500 dark:text-zinc-400 hover:text-zinc-700 dark:hover:text-zinc-900 dark:text-white transition-colors"
                  >
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <select 
                    ...
                    className="w-full appearance-none bg-white dark:bg-black border border-zinc-200 dark:border-zinc-800 rounded-lg py-2.5 px-3 text-sm text-zinc-700 dark:text-zinc-700 dark:text-zinc-300 focus:border-zinc-400 dark:focus:border-zinc-600 focus:outline-none transition-colors"
                  >
                    ...
                    <button
                      ...
                      className={`text-xs px-2 py-1 rounded border transition-colors ${
                        learningRate === lr 
                          ...
                          : 'bg-zinc-900 text-zinc-500 dark:text-zinc-400 border-zinc-700 hover:border-zinc-500'
                      }`}
                    >
                      {lr}
                    </button>
              ...
              <div className="pt-6 border-t border-zinc-800/50 space-y-4">
                <label className="flex items-center justify-between cursor-pointer group">
                  <span className="text-sm text-zinc-500 dark:text-zinc-500 dark:text-zinc-400 group-hover:text-zinc-700 dark:group-hover:text-zinc-700 dark:text-zinc-200 transition-colors">Generate Dataset Archive</span>
                ...
                <label className="flex items-center justify-between cursor-pointer group">
                  <span className="text-sm text-zinc-500 dark:text-zinc-500 dark:text-zinc-400 group-hover:text-zinc-700 dark:group-hover:text-zinc-700 dark:text-zinc-200 transition-colors">Archive Only Mode</span>
              ...
              <div className="bg-zinc-100 dark:bg-zinc-50 dark:bg-zinc-900/30 border border-zinc-800/50 rounded-2xl p-6 backdrop-blur-sm">
                ...
                <div className="space-y-2">
                  {recentExperiments.map((exp) => (
                    <div key={exp.id} className="flex justify-between items-center p-3 bg-white dark:bg-black/30 rounded-lg border border-zinc-800/50">
                      <div>
                        <div className="text-sm text-zinc-700 dark:text-zinc-300 font-medium">{exp.model}</div>
        ...
        <section className="lg:col-span-8 flex flex-col gap-6">
           ...
           {(isRunning || progress > 0) && (
             <div className="bg-zinc-100 dark:bg-zinc-50 dark:bg-zinc-900/30 border border-zinc-800/50 rounded-2xl p-6 backdrop-blur-sm">
                <div className="flex justify-between items-end mb-4">
                    <div>
                        <h3 className="text-sm font-medium text-zinc-500 dark:text-zinc-400 uppercase tracking-widest">Training Progress</h3>
                        <p className="text-2xl font-light text-zinc-900 dark:text-white mt-1">
                    ...
                    <div className="text-right">
                       <div className="text-3xl font-bold font-mono text-zinc-900 dark:text-white tracking-tighter">{currentStatus?.accuracy ? `${(parseFloat(currentStatus.accuracy)*100).toFixed(2)}%` : "0.00%"}</div>
           ...
           {/* Content Tabs */}
           <div className="bg-zinc-100 dark:bg-zinc-50 dark:bg-zinc-900/30 border border-zinc-800/50 rounded-2xl flex-1 flex flex-col overflow-hidden h-auto max-h-[60vh] backdrop-blur-sm">
              <div className="flex border-b border-zinc-800/50 px-2 flex-none">
                 <button 
                   onClick={() => setActiveTab('logs')}
                   className={cn("px-6 py-4 text-sm font-medium border-b-2 transition-all flex items-center gap-2", activeTab === 'logs' ? "border-white text-zinc-900 dark:text-white" : "border-transparent text-zinc-500 hover:text-zinc-700 dark:text-zinc-300")}
                 >
                   <Terminal className="w-4 h-4" /> Logs
                 </button>
                 <button 
                   onClick={() => setActiveTab('charts')}
                   className={cn("px-6 py-4 text-sm font-medium border-b-2 transition-all flex items-center gap-2", activeTab === 'charts' ? "border-white text-zinc-900 dark:text-white" : "border-transparent text-zinc-500 hover:text-zinc-700 dark:text-zinc-300")}
                 >
                   <BarChart2 className="w-4 h-4" /> Metrics
                 </button>
                 <button 
                   onClick={() => setActiveTab('results')}
                   className={cn("px-6 py-4 text-sm font-medium border-b-2 transition-all flex items-center gap-2", activeTab === 'results' ? "border-white text-zinc-900 dark:text-white" : "border-transparent text-zinc-500 hover:text-zinc-700 dark:text-zinc-300")}
                 >
                   <CheckCircle className="w-4 h-4" /> Results
                 </button>
              </div>

              <div className="flex-1 overflow-y-auto bg-white dark:bg-black/50 scrollbar-thin">
                 {activeTab === 'logs' && (
                   <div className="p-6 font-mono text-xs space-y-1.5 h-full">
                      ...
                      {logs.map((log, i) => (
                        <div key={i} className="flex gap-3 text-zinc-700 dark:text-zinc-300 border-l-2 border-transparent hover:bg-zinc-100 dark:bg-zinc-900/50 pl-2 -ml-2 py-0.5 rounded transition-colors group">
                           ...
                           <span className={cn(
                             ...
                             log.type === 'success' ? 'text-emerald-400' : 'text-zinc-700 dark:text-zinc-300'
                           )}>
                         ...
                         <>
                           <div className="h-[250px] w-full">
                              <div className="flex justify-between mb-4">
                                <h4 className="text-sm font-medium text-zinc-500 dark:text-zinc-400 uppercase tracking-widest">Model Accuracy</h4>
                           ...
                           <div className="h-[250px] w-full">
                              <div className="flex justify-between mb-4">
                                <h4 className="text-sm font-medium text-zinc-500 dark:text-zinc-400 uppercase tracking-widest">Loss Function</h4>
                    ...
                    <div className="p-8">
                       {evalResult ? (
                         <div className="space-y-10">
                            {/* Summary Stats */}
                            <div>
                              <h3 className="text-sm font-medium text-zinc-500 dark:text-zinc-400 uppercase tracking-widest mb-6">Performance Summary</h3>
                              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                 {/* Stat Cards */}
                                 {[
                                   { label: "Total Epochs", value: evalResult.total_epochs },
                                   { label: "Test Set Size", value: evalResult.test_size },
                                   { label: "Precision (Avg)", value: evalResult.report['weighted avg']?.precision.toFixed(4) ?? 'N/A', color: 'text-zinc-900 dark:text-zinc-100' },
                                   { label: "Recall (Avg)", value: evalResult.report['weighted avg']?.recall.toFixed(4) ?? 'N/A', color: 'text-zinc-900 dark:text-zinc-100' },
                                 ].map((stat, i) => (
                                   <div key={i} className="p-5 bg-zinc-100 dark:bg-zinc-900/50 rounded-xl border border-zinc-800/50">
                                      <div className="text-xs text-zinc-500 uppercase tracking-wider mb-2">{stat.label}</div>
                                      <div className={cn("text-2xl font-bold font-mono", stat.color || "text-zinc-900 dark:text-white")}>{stat.value}</div>
                                   </div>
                                 ))}
                              </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
                              {/* Left: CM */}
                              <div>
                                 <h3 className="text-sm font-medium text-zinc-500 dark:text-zinc-400 uppercase tracking-widest mb-6">Confusion Matrix</h3>
                              ...
                              <div>
                                <h3 className="text-sm font-medium text-zinc-500 dark:text-zinc-400 uppercase tracking-widest mb-6">Classification Report</h3>
                                <div className="overflow-auto max-h-[500px] rounded-xl border border-zinc-800 bg-zinc-100 dark:bg-zinc-900/20 scrollbar-thin">
                                   <table className="w-full min-w-[600px] text-sm text-left relative border-collapse">
                                      <thead className="sticky top-0 z-10 bg-white dark:bg-black/90 backdrop-blur-md shadow-sm">
                                         <tr>
                                            <th className="px-5 py-4 whitespace-nowrap text-xs font-semibold text-zinc-500 dark:text-zinc-400 uppercase tracking-wider border-b border-zinc-800">Class</th>
                                            <th className="px-5 py-4 whitespace-nowrap text-xs font-semibold text-zinc-500 dark:text-zinc-400 uppercase tracking-wider border-b border-zinc-800 text-right">Precision</th>
                                            <th className="px-5 py-4 whitespace-nowrap text-xs font-semibold text-zinc-500 dark:text-zinc-400 uppercase tracking-wider border-b border-zinc-800 text-right">Recall</th>
                                            <th className="px-5 py-4 whitespace-nowrap text-xs font-semibold text-zinc-500 dark:text-zinc-400 uppercase tracking-wider border-b border-zinc-800 text-right">F1-Score</th>
                                            <th className="px-5 py-4 whitespace-nowrap text-xs font-semibold text-zinc-500 dark:text-zinc-400 uppercase tracking-wider border-b border-zinc-800 text-right">Support</th>
                                         </tr>
                                      </thead>
                                          ...
                                          {Object.entries(evalResult.report).map(([key, val]: [string, any]) => {
                                             ...
                                             return (
                                               <tr key={key} className="group hover:bg-white/5 transition-colors">
                                                  <td className="px-5 py-3 font-mono text-zinc-700 dark:text-zinc-300 font-medium whitespace-nowrap group-hover:text-zinc-900 dark:text-white border-r border-dashed border-zinc-800/30">{key}</td>
                                                  <td className="px-5 py-3 whitespace-nowrap text-right font-mono text-zinc-500 dark:text-zinc-400">{val.precision?.toFixed(4)}</td>
                                                  <td className="px-5 py-3 whitespace-nowrap text-right font-mono text-zinc-500 dark:text-zinc-400">{val.recall?.toFixed(4)}</td>
                                                  <td className="px-5 py-3 whitespace-nowrap text-right font-mono text-zinc-700 dark:text-zinc-300 font-semibold">{val.f1_score?.toFixed(4) ?? val['f1-score']?.toFixed(4)}</td>
